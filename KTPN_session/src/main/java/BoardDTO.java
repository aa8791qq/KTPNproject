...
// this. 이게 왜 생기는 지 알아볼것
	public int getBRO_NO() {
		return BRO_NO;
	}

	public void setBRO_NO(int bRO_NO) {
		BRO_NO = bRO_NO;
	}
	...
	public String toString() {
		return "BoardDTO [BRO_NO = " + BRO_NO + ", BRD_SENM = " + BRD_SENM + ", TTL_NM = " + TTL_NM + ", BRD_DESC = "
				+ BRD_DESC + ", BLND_YN = " + BLND_YN + ", VW_CNT = " + VW_CNT + ", DLT_YN = " + DLT_YN
				+ ", REG_DTTM = " + REG_DTTM + ", MOD_DTTM = " + MOD_DTTM + ", ID = " + ID + "]";
	}
}
